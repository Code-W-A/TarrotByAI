...
import PersonListScreenAstrograma from "./src/pages/astral/initials/PersonListScreenAstrograma";
import NewPersonAstrograma from "./src/pages/astral/initials/NewPersonAstrogramaScreen";
...
// import NumberScreen from "./src/pages/astral/initials/number.screen";
// import LoadingScreen from "./src/pages/astral/initials/loading.screen";
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <Stack.Screen name={"Astral"} component={NameScreen} />
        ...
        />
        <Stack.Screen
          name="AstrogramaNatala"
          component={AstrogramaNatala}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="AstrogramaNatalaOtherPersonData"
          component={AstrogramaNatalaOtherPerson}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="Horoscop"
        ...
        />
        <Stack.Screen
          name="NewTwoPersonsSinastry"
          component={NewTwoSyanstryPersons}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="NewPersonAstrograma"
          component={NewPersonAstrograma}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="Persons"
        ...
        />
        <Stack.Screen
          name="SinastrieOthers"
          component={SinastrieRelatieOthers}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="Sinastrie"
