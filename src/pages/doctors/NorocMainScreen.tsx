            ...
            >
              ...
              <View style={stylesNew.sectionContainer}>
                ...
                <View style={{ marginTop: 24 }}>
                  {[
                    { text: i18n.translate("luckyNumber"), screen: screenName.luckyNumber, icon: <MaterialCommunityIcons name="dice-multiple-outline" size={48} color="#FFD700" style={{ marginRight: 18 }} /> },
                    { text: i18n.translate("luckyColor"), screen: screenName.luckyColor, icon: <MaterialCommunityIcons name="palette-outline" size={48} color="#FFD700" style={{ marginRight: 18 }} /> },
                    { text: i18n.translate("luckyHours"), screen: screenName.luckyHour, icon: <MaterialCommunityIcons name="clock-outline" size={48} color="#FFD700" style={{ marginRight: 18 }} /> },
                  ].map((card, index) => (
                    <TouchableOpacity
                      key={index}
...
export default NorocMainScreen;
