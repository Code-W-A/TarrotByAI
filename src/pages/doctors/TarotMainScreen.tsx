            ...
            >
              ...
              <View style={stylesNew.sectionContainer}>
                ...
                <View style={{ marginTop: 24 }}>
                  {[
                    { text: i18n.translate("personalReading"), screen: screenName.PersonalReadingDashboard, icon: <MaterialCommunityIcons name="cards-outline" size={48} color="#FFD700" style={{ marginRight: 18 }} /> },
                    { text: i18n.translate("futureReading"), screen: screenName.FutureReadingDashboard, icon: <MaterialCommunityIcons name="crystal-ball" size={48} color="#FFD700" style={{ marginRight: 18 }} /> },
                    { text: i18n.translate("carteaTa"), screen: "CarteaTa", icon: <MaterialCommunityIcons name="book-open-variant" size={48} color="#FFD700" style={{ marginRight: 18 }} /> },
                    { text: i18n.translate("ceGandeste"), screen: "CeGandeste", icon: <MaterialCommunityIcons name="head-question-outline" size={48} color="#FFD700" style={{ marginRight: 18 }} /> },
                    { text: i18n.translate("ceSimte"), screen: "CeSimte", icon: <MaterialCommunityIcons name="heart-outline" size={48} color="#FFD700" style={{ marginRight: 18 }} /> },
                    { text: i18n.translate("EnergiaDinRelație"), screen: "EnergiaDinRelație", icon: <MaterialCommunityIcons name="infinity" size={48} color="#FFD700" style={{ marginRight: 18 }} /> },
                    { text: i18n.translate("ViitorApropiat"), screen: "ViitorApropiat", icon: <MaterialCommunityIcons name="timeline-clock-outline" size={48} color="#FFD700" style={{ marginRight: 18 }} /> },
                  ].map((card, index) => (
                    <TouchableOpacity
                      key={index}
...
export default TarotMaineScreen;
