...
//---ADS--- TEMPORARILY DISABLED FOR DEBUGGING
// import {
//   InterstitialAd,
//   AdEventType,
//   TestIds,
    ...
    try {
      if (isFuture) {
        ...
        if (filteredVariante.length > 0) {
          ...
          // Direct navigation without ads
          navigation.navigate("PersonalizedReading", {
            item: selectedCard,
          });
        } else {
          console.log(
    ...
    <>
      ...
      <TouchableWithoutFeedback onPress={flipCard}>
        <Animated.View style={[styles.container, style]}>
          ...
          <TouchableWithoutFeedback
            onPress={() => navigateToPersonalizedReading(true)}
          >
...
const styles = StyleSheet.create({
  ...
  shadowImage: {
    ...
    left: -195,
    width: Dimensions.get("window").width / 3.55 + 350, // Lățimea și înălțimea sunt mărite
    height: Dimensions.get("window").width / 4.8 + 350,
