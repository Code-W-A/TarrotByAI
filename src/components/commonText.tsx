...
export const H6fontMediumWhite = ({ children }) => (
  <Text style={[styles.h6, styles.fontMedium, styles.white]}>{children}</Text>
);
...
export const H3fontBoldWhite = ({ children }) => (
  <Text style={[styles.h3, styles.fontBold, styles.white]}>{children}</Text>
);
