...
export default function RattingDialog({ setVisible, visible }) {
  ...
  const onSubmit = async () => {
    ...
    setVisible(!visible);
    let url =
      "https://play.google.com/store/apps/details?id=com.cristina.zurba.tarot&hl=en&gl=US";
          ...
          >
            ...
            <View style={styles.titleContainer}>
              ...
              <Text style={styles.subTitle}>
                {i18n.translate("descriereRate")}
              </Text>
              <View style={styles.starsContainer}>{renderStars()}</View>
              {rating <= 3 && rating > 0 && (
                <>
                  <Text style={styles.feedbackTitle}>
                    {i18n.translate("feedbackPrompt")}
                  </Text>
                  <TextInput
                    mode="outlined"
            ...
            <View style={styles.actionContainer}>
              ...
              <GradientButton
                hasRated={rating > 0}
                label={rating > 0 ? "Submit" : "Rate to submit"}
                onPress={() => onSubmit()}
              />
            </View>
          </Modal>
